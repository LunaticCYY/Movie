    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ScoreId = c.Decimal(nullable: false, precision: 10, scale: 0),
                        UserId = c.Decimal(nullable: false, precision: 10, scale: 0),
                        ScoreTime = c.String(nullable: false),
                        VideoId = c.Decimal(nullable: false, precision: 10, scale: 0),
                        Mark = c.Decimal(nullable: false, precision: 10, scale: 0),
                    })
