        ...
        protected override void Seed(Movie.Models.MovieContext context)
        {
            context.Users.AddOrUpdate(i => i.UserId,
                new User
                {
                    ...
                    Password = "123456",
                    Email = "test1@qq.com",
                    Privilege = Models.User.Privileges.禁言会员
                },
                new User
                {
                    UserId = 2,
                    ...
                    Password = "123456",
                    Email = "test2@qq.com",
                    Privilege = Models.User.Privileges.普通会员
                },
                new User
                {
                    UserId = 3,
                    ...
                    Password = "123456",
                    Email = "test3@qq.com",
                    Privilege = Models.User.Privileges.高级会员
                },
                new User
                {
                    UserId = 4,
                    ...
                    Password = "123456",
                    Email = "test4@qq.com",
                    Privilege = Models.User.Privileges.管理员
                }
            );
